...
if __name__ == "__main__":
    ...
    # script is in notebooks/sql (depth 2 from root), data is in data (depth 0 from root)
    data_dir = Path(__file__).parent.parent.parent / "data" / "opendata"
    ...
    export_path = Path(__file__).parent.parent.parent / "data" / "exports" / "nyc_speeding_violations_over_18_months.csv"
    print(f"Exporting to: {export_path}")
    df_sum.to_csv(export_path, index=False)